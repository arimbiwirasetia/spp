...
<div class="container-fluid">
    ...
    <div class="col-xl-6 col-md-6 ml-3">
        <form action="<?= baseurl ?>admin_pembayaran/doEdit/<?= $data["pembayaran"]["id"] ?>" method="post" class="form">
            <div class="form-group">
                <input type="hidden" class="form-control" id="id" name="id" value="<?= $data["pembayaran"]["id"] ?>" aria-describedby="idKls">
            </div>
            <div class="form-group">
            ...
            <div class="d-sm-flex align-items-center justify-content-between">
                <a type="button" class="btn btn-secondary" data-dismiss="modal" href="<?= baseurl ?>admin_pembayaran/index">Batal</a>
