            ...
            <tbody class="table-group-divider">
                <?php foreach ($data["kelas"] as $kelas) : ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= baseurl ?>admin_kelas/edit/<?= $kelas["id"] ?>" class="badge-warning badge-pill px-2.5 mr-2">edit</a>
                            <a href="<?= baseurl ?>admin_kelas/hapus/<?= $kelas['id'] ?>" class="badge-danger badge-pill px-2.5" onclick="return confirm('yakin ingin menghapus data?')">delete</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= baseurl ?>admin_kelas/tambah" method="post">
                    <div class="form-group">
                        <label for="nama">Tingkat</label>
                        <input type="text" class="form-control" id="nama" name="nama" aria-describedby="tingkatKls">
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-footer d-sm-flex align-items-center justify-content-between">
                <button type="button" class="btn btn-secondary" data-dismiss="modal" href="<?= baseurl ?>admin_kelas">Batal</button>
