            ...
            <tbody class="table-group-divider">
                <?php foreach ($data["pengguna"] as $pengguna) : ?>
                    <tr>
                        ...
                        <td><?= $pengguna["role"]; ?></td>
                        <td>
                            <a href="<?= baseurl ?>admin/editPengguna/<?= $pengguna["id_pengguna"] ?>" class="badge-warning badge-pill px-2.5 mr-2">edit</a>
                            <a href="<?= baseurl ?>admin/hapusPengguna/<?= $pengguna["id_pengguna"] ?>" class="badge-danger badge-pill px-2.5" onclick="return confirm('yakin ingin menghapus data?')">delete</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= baseurl ?>admin/tambahPengguna" method="post">
            ...
            <div class=" modal-footer d-sm-flex align-items-center justify-content-between">
                <button type="button" class="btn btn-secondary" data-dismiss="modal" href="<?= baseurl ?>admin/pengguna">Batal</button>
