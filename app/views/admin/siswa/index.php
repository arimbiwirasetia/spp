...
<div class="container-fluid">
    ...
    <!-- Content Row -->
    <div class="col-xl-11 col-md-3 ml-3 mt-5">
                ...
                <?php foreach ($data["siswa"] as $siswa) : ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?= baseurl ?>admin/hapusSiswa/<?= $siswa["id_siswa"] ?>" class="text-danger">
            ...
            <div class="modal-body">
                <form action="<?= baseurl ?>admin/tambahSiswa" method="post" class="mx-3">
                    ...
                    <div class="form-group">
                        ...
                        <select class="custom-select" name="pengguna_id" id="pengguna_id">
                    ...
                    <div class="form-group">
                        ...
                        <select class="custom-select" name="tahun_ajaran" id="tahun_ajaran">
                    ...
                    <div class="form-group">
                        ...
                        <select class="custom-select" name="pembayaran_id" id="pembayaran_id">
                            <?php foreach ($data["pembayaran"] as $pembayaran) : ?>
                                <option value="<?= $pembayaran["id_pembayaran"] ?>"><?= $pembayaran["tahun_ajaran"] ?> - Rp<?= $pembayaran["nominal"] ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
            </div>
