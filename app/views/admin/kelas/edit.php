...
<div class="container-fluid">
    ...
    <div class="col-xl-6 col-md-6 ml-3">
        <form action="<?= baseurl ?>admin/prosesEditKelas" method="post" class="form">
            ...
            <div class="d-sm-flex align-items-center justify-content-between">
                <a type="button" class="btn btn-secondary" data-dismiss="modal" href="<?= baseurl ?>admin/kelas">Batal</a>
