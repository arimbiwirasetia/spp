            ...
            <tbody class="table-group-divider">
                <?php foreach ($data["pembayaran"] as $pembayaran) : ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= baseurl ?>admin/editPembayaran/<?= $pembayaran["id_pembayaran"] ?>" class="badge-warning badge-pill px-2.5 mr-2">edit</a>
                            <a href="<?= baseurl ?>admin/hapusPembayaran/<?= $pembayaran["id_pembayaran"] ?>" class="badge-danger badge-pill px-2.5" onclick="return confirm('yakin ingin menghapus data?')">delete</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= baseurl ?>admin/tambahPembayaran" method="post">
