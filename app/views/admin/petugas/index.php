            ...
            <tbody class="table-group-divider">
                <?php foreach ($data["petugas"] as $petugas) : ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= baseurl ?>admin_petugas/edit/<?= $petugas["id"] ?>" class="badge-warning badge-pill px-2.5 mr-2">edit</a>
                            <a href="<?= baseurl ?>admin_petugas/hapus/<?= $petugas['id'] ?>" class="badge-danger badge-pill px-2.5" onclick="return confirm('yakin ingin menghapus data?')">delete</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= baseurl ?>admin_petugas/tambah" method="post">
