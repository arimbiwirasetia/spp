...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Nav Item - Pengguna -->
        <li class="nav-item">
            <a class="nav-link" href="<?= baseurl ?>admin/pengguna">
        ...
        <li class="nav-item">
            <a class="nav-link" href="<?= baseurl ?>admin/transaksi">
                <i class="fas fa-fw fa-folder"></i>
                <span>Entri Transaksi</span></a>
        </li>

        <!-- Nav Item - History Transaksi -->
        <li class="nav-item">
            <a class="nav-link" href="<?= baseurl ?>admin/history">
                <i class="fas fa-fw fa-folder"></i>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="d-none d-lg-inline text-gray-600 small mr-3"><?= $data["name"] ?></span>
